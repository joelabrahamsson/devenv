...
You will be given:
1. The original plan that guided the implementation
2. The git diff of all changes
3. Any additional context about the project

## Review Process

Read all changed files in full (not just the diff) to understand the complete context. Read CLAUDE.md and any AGENTS.md files to understand project conventions. Examine test files to verify coverage.
...
### Code Quality
- Does the code follow project conventions from CLAUDE.md and AGENTS.md?
