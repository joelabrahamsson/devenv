---
name: bdd-spec
description: Collaboratively produce BDD specification tests through structured conversation. The agent elicits specs from you — it doesn't write them for you.
argument-hint: "[feature to specify, or 'revise path/to/spec']"
user-invocable: true
allowed-tools: "Write Edit Read Glob Grep Bash AskUserQuestion"
effort: high
---
...
1. Read the project's CLAUDE.md / AGENTS.md for test setup information
