---
name: finalize
description: Generate an ADR from a completed plan implementation, clean up the plan file, and commit/push or create a PR. Invoke with $finalize optionally followed by the path to the plan file.
---
